...
class emp_login(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.base_url = self.emp+"/pay/addBankCard"
    ...
    def test_login_success(self):
        ''' 完备的参数'''
        sdata = {"userId":"99999958","bankLogo":"图片base64转码字符串，用MEDIUMTEXT字段存储","cardNo":"63282347923401234","cardBank":"建设银行","cardName":"张三",'sourceFrom':'1'}
